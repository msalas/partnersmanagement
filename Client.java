...
public class Client extends JFrame {
	...
	private void initComponents() {
		...
		jDialog1.setBounds(200,200,500,400);
	...
	private void jButton5ActionPerformed(ActionEvent evt) {
		...
		try {
			...
			if(preu.length()==0) throw new errorCampBuit("Import: Camp buit");
			
			cm.inserirContracte(idContracte,nomEmpresa, dataAlta, dataRes, preu);
			
			JOptionPane.showMessageDialog(this, "El contracte s'ha inserit amb èxit");
